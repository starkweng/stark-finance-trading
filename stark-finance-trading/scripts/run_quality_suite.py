    ...
    steps = [
        ...
        (
            ...
            [
                ...
                str(dist_for_cmd),
                "--out",
                str(dist_for_cmd / "stark-finance-trading.release-blocker-plan.json"),
                "--markdown",
                str(dist_for_cmd / "stark-finance-trading.release-blocker-plan.md"),
                "--json",
            ],
        ),
        (
