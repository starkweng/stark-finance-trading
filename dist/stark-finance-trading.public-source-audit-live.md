...
| Token Terminal MCP | `official_mcp` | WARN | https://tokenterminal.com/docs/mcp/introduction |
...
| Moralis Cortex MCP | `official_mcp` | WARN | https://docs.moralis.com/data-api/cortex-api/overview |
...
This audit checks source classification and optional URL reachability only. It does not verify API credentials, live model behavior, trading performance, or public superiority.
