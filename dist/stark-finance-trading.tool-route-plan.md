...
| `hummingbot-market-making-dry-run` | PASS | 3 | `binance-skills-hub, quantconnect-mcp, lean, hummingbot, freqtrade, ccxt, alpaca-mcp, nautilus-trader, coingecko-mcp, massive-polygon-mcp, twelve-data-mcp` |
...
| `openbb-options-research-boundary` | PASS | 4 | `openbb, fmp-mcp, alpaca-mcp, unusual-whales-mcp, tradier-mcp, massive-polygon-mcp, alpha-vantage-mcp` |
| `alpaca-paper-live-boundary` | PASS | 4 | `openbb, fmp-mcp, alpaca-mcp, tradier-mcp, ibkr-tws-api, massive-polygon-mcp, alpha-vantage-mcp` |
