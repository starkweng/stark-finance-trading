...
|---|---:|---|---|---|---:|---|
| hummingbot/hummingbot | 19005 | broker_execution, onchain, backtest, bot_framework | PARTIAL_RUNTIME | requires_secret_or_auth | 140.95 | https://github.com/hummingbot/hummingbot |
...
| ccxt/ccxt | 43093 | backtest, bot_framework, onchain | PARTIAL_RUNTIME | requires_secret_or_auth | 133.44 | https://github.com/ccxt/ccxt |
...
| freqtrade/freqtrade | 51899 | bot_framework | COVERED_WITH_LIVE_GATING_REQUIRED | add_route_eval | 115.01 | https://github.com/freqtrade/freqtrade |
...
| Thysrael/Horizon | 7527 | mcp, bot_framework | COVERED_WITH_LIVE_GATING_REQUIRED | add_route_eval | 109.14 | https://github.com/Thysrael/Horizon |
...
| ccxt/ccxt | 43093 | backtest, bot_framework, onchain | PARTIAL_RUNTIME | Route into backtest/research stacks, keep assumptions explicit, and require simulation or paper proof before live execution. Treat bot frameworks as strategy/runtime substrates behind live_gating_required and kill-switch review. Use Dune/Alchemy/Binance where configured; keep Etherscan and endpoint-specific surfaces gated by env/auth checks. |
...
| freqtrade/freqtrade | 51899 | bot_framework | COVERED_WITH_LIVE_GATING_REQUIRED | Treat bot frameworks as strategy/runtime substrates behind live_gating_required and kill-switch review. |
...
| Thysrael/Horizon | 7527 | bot_framework, mcp | COVERED_WITH_LIVE_GATING_REQUIRED | Treat bot frameworks as strategy/runtime substrates behind live_gating_required and kill-switch review. Use MCP as a substrate, but only promote concrete finance routes with source, auth, and safety metadata. |
