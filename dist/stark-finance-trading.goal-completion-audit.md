...
| `public_tool_catalog_coverage` | PROVEN | catalog_tools=49; required_missing=[] | Add missing required public tool IDs to references/public-tool-catalog.json. |
...
| `route_regression_coverage` | PROVEN | route_plan_status=PASS; cases=23/23 | Fix scripts/plan_tool_route.py or evals/tool-routing-cases.json. |
...
| `integration_activation_plan_generated` | PROVEN | activation_status=PASS; ready_now=11; quick=2; priority_backlog=22; high_risk=13 | Run scripts/generate_integration_activation_plan.py after runtime capability scan. |
| `release_blocker_plan_generated` | PROVEN | blocker_plan_status=ACTIONABLE_BLOCKERS_OPEN; blockers=4; categories={'needs_secret_or_env': 1, 'needs_github_permission': 1, 'needs_live_eval_approval': 2} | Run scripts/generate_release_blocker_plan.py after external proof audit. |
| `quality_suite_green` | PROVEN | quality_status=PASS; steps=49 | Rerun scripts/run_quality_suite.py and fix failing steps. |
| `package_and_export_ready` | PROVEN | release_status=PASS; package_sha=e0dd5fdc6bb8eb04e5e518865e5acf6d65fa6f1b04bc054cd9297ed95f6e994a; package_entries=64; github_zip_sha=755cf199c6f3d24b92b3e55bf619dfbd43129ac3ca6fb009ca9ed192deacf259; github_zip_entries=135; github_smoke=PASS | Regenerate package, GitHub export, export smoke, and release readiness. |
