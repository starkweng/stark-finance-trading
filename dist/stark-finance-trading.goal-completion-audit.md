...
| `public_tool_catalog_coverage` | PROVEN | catalog_tools=39; required_missing=[] | Add missing required public tool IDs to references/public-tool-catalog.json. |
...
| `integration_activation_plan_generated` | PROVEN | activation_status=PASS; ready_now=11; quick=2; priority_backlog=13; high_risk=5 | Run scripts/generate_integration_activation_plan.py after runtime capability scan. |
...
| `package_and_export_ready` | PROVEN | release_status=PASS; package_sha=4d366b79ae28718f76837254ea38d9e787d876eb2b55ff2f64ee46af9083e012; package_entries=64; github_zip_sha=dbff007c9d9dd600ce0472c2cc99d66b5f5548dc8fa4589aa34ef2145681d604; github_zip_entries=135; github_smoke=PASS | Regenerate package, GitHub export, export smoke, and release readiness. |
